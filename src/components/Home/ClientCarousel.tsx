...
import '../../styles/client-carousel.css'
import centurionLogo from '../../images/client-logos/centurion-logo.png'
import onwardLogo from '../../images/client-logos/onward-logo.png'
import rclcLogo from '../../images/client-logos/rclc-logo.png'
import senderoLogo from '../../images/client-logos/sendero-logo.avif'
import sidekickLogo from '../../images/client-logos/sidekick-logo.png'
...
export const ClientCarousel = () => {
    ...
    return (
        <div className="client-carousel_embla">
