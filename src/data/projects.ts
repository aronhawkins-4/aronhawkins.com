...
export const projects: Project[] = [
	...
	},
	{
		...
		solution: "<p>Aron also developed the website for Knife Italian. The site allows users to easily browse restaurant menus, make dining and special event reservations, and view the dining areas and delicious dish offerings.</p><p>Aron Hawkins built a web application that allows digital assets, such as images, PDF documents, and videos to be easily organized, searched for, and downloaded. This app utilizes a Content Management System so the Ritz-Carlton marketing team can manage uploading, editing, and deleting assets without the need for outside help. The app saves their team time, allowing them to focus on creating the best campaigns possible. For privacy purposes, this project is not able to be shown for privacy purposes.</p>",
